...
lwc_final = np.repeat(lwc_final,3,axis=2)
...
# save once
np.savetxt(cams_dir+'AngstromCal_'+fname+'_aod355nm_per_composition_'+month+'_2025_cams_atlid_co-located.txt',
