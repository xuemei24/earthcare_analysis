...
fcams = cams_dir+'AngstromCal_'+which_aerosol+'_aod355nm_per_composition_'+month+'_2025_cams_atlid_co-located.txt'
...
plt.tight_layout()
fig.savefig('global_aod_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located_AngstromCal.jpg',bbox_inches='tight')
...
fig.savefig('histograms_CAMS_ATLID_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located_AngstromCal.jpg')
...
ax2.legend(frameon=False,fontsize=15)
ax3.legend(frameon=False,fontsize=15)
fig.savefig('histograms_CAMS_ATLID_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located_with_modes_AngstromCal.jpg')
