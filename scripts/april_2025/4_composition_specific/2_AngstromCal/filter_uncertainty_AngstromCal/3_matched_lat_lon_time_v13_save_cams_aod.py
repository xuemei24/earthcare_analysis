...
fcams = cams_dir+'Angstrom_aod355nm_per_composition_'+month+"_"+year+".nc"
...
# save once
np.savetxt(cams_dir+'AngstromCal_'+fname+'_aod355nm_per_composition_'+month+'_'+year+'_cams_atlid_co-located_snr_gr_2.txt',
