...
script_path = '/scratch/nld6854/earthcare/earthcare_scripts/scripts/april_2025/'
...
fcams = cams_dir+'TTcal_'+which_aerosol+'_aod355nm_per_composition_'+month+'_2025_cams_atlid_co-located.txt'

df = pd.read_csv(fcams, delimiter=",")
...
bounds2 = np.linspace(-vmax/2,vmax/2,10)
norm2 = colors.BoundaryNorm(bounds2,ncolors=plt.colormaps['RdBu_r'].N,clip=True)
im=ax3.pcolormesh(clons,clats,aod_cams-aod_atlid,cmap='RdBu_r',transform=ccrs.PlateCarree(),norm=norm2)
...
plt.tight_layout()
fig.savefig('global_aod_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located_TTcal.jpg',bbox_inches='tight')
...
fig.savefig('histograms_CAMS_ATLID_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located_TTcal.jpg')
...
ax2.legend(frameon=False,fontsize=15)
ax3.legend(frameon=False,fontsize=15)
fig.savefig('histograms_CAMS_ATLID_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located_with_modes_TTcal.jpg')
