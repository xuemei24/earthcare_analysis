...
cams_data = ['sea_salt_0.03-0.5', 'sea_salt_0.5-5', 'sea_salt_5-20','dust_0.03-0.55', 'dust_0.55-0.9', 'dust_0.9-20','hydrophilic_organic_matter','hydrophobic_organic_matter','hydrophilic_black_carbon','hydrophobic_black_carbon','sulfate','nitrate_fine_mode','nitrate_coarse_mode','ammonium']
...
#load AOD files
faod355 = xr.open_dataset(cams_dir+'cams_original_files/total_aerosol_optical_depth_355nm_'+month+'_2025.nc')
...
faod550 = xr.open_dataset(cams_dir+'cams_original_files/multiple_aod_550nm_'+month+'_2025.nc') #12,60,451,900
...
fsurfp = xr.open_dataset(cams_dir+'cams_original_files/surface_pressure_'+month+'_2025.nc') #12,60,451,900
all_Pressure_s = fsurfp['sp']
fsurfp.close()

fgeop = xr.open_dataset(cams_dir+'cams_original_files/surface_geopotential_'+month+'_2025.nc') #12,60,451,900
...
for lforecast_period in forecast_periods:
    ...
    for iff in range(length): #forecast reference time
        ...
        ftemp = xr.open_dataset(cams_dir+'cams_original_files/temperature_'+month+'_2025_'+lforecast_period+'.nc') #xxx #1,60,137,451,900
        Temperature_f = ftemp['t'][0,iff]#xxx
        ftemp.close()
 
        fqt = xr.open_dataset(cams_dir+'cams_original_files/specific_humidity_'+month+'_2025_'+lforecast_period+'.nc') #xxx #1,60,137,451,900
        ...
        for w in [10,11]: # 10 = 393 nm, 11 = 304 nm
            for i in range(len(MR_names)):  # Loop through tracer names
                file_path = cams_dir+'cams_original_files/'+cams_data[i]+suffix1+lforecast_period+suffix2
