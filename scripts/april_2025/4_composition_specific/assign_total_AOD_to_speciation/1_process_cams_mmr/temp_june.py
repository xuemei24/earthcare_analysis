...
cams_data = ['nitrate_coarse_mode', 'nitrate_fine_mode', 'sea_salt_0.03-0.5', 'sea_salt_0.5-5', 'sea_salt_5-20', 'sulfate'] 
var_names = ['aermr17','aermr16','aermr01','aermr02','aermr03','aermr11']
...
for data,var_name in zip(cams_data,var_names):
    ...
    for forecast_period in forecast_periods:
        ...
        output_filename = cams_dir+'integrated_'+var_name+'_'+data+suffix1+forecast_period+suffix2
        regridded_data_xr.to_netcdf(output_filename)
