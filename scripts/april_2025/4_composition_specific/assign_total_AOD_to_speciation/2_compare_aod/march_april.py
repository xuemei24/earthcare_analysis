...
for aero_type,fig_name, faod,caod in zip(aero_types,fig_names,faods,caods):
    ...
    plt.tight_layout()
    fig.savefig('global_aod_'+aero_type+'_2deg_binned_'+mean_or_std+'_'+month+'_2025_trimedges_filterCAMScloud_TC.jpg',bbox_inches='tight')
    ...
    fig.savefig('global_'+aero_type+'_histograms_CAMS_ATLID_2deg_binned_'+mean_or_std+'_'+month+'_2025_trimedges_filterCAMScloud_TC.jpg')
