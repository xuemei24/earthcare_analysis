...
cams_dir = '/net/pc200254/nobackup/users/wangxu/cams_data/aerosol_mmr/'+month+'/temp/'
...
for aero_type in aero_types:
    ...
    for forecast_reference_time in [3,6,9,12]:
        ...
        file_list = [cams_dir+aero_type+"_extinction_coefficient__mmr_"+month+"_2025_slice_"+str(itime)+"_"+str(forecast_reference_time)+".nc" for itime in range(60)]
