...
#args = [(fp, np.array([10,13,14,15])) for fp in file_paths] # 11 = SSA, 10 = Dust, 13 = Smoke, 14 = Dusty smoke, 15 = Dusty mix
args = [(fp, np.array([11])) for fp in file_paths]
...
np.savetxt('2025_'+month+'_aod_'+output_file+'.txt',np.array([all_lat,all_lon,all_aod]).transpose(),header='latitude,longitude,aod355nm',delimiter=',')
...
title='AOD_'+month+'_2025_'+output_file
