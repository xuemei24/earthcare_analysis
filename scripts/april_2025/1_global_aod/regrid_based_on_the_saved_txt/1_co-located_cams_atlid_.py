...
fmonth = 'August'
print('Month=',month)
df = pd.read_csv(file_dir+month+'_2025/'+"2025_"+month+"_cams_atlid_co-located_aod.txt", delimiter=",")
...
plt.tight_layout()
fig.savefig('figures/global_aod_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located.jpg',bbox_inches='tight')
...
fig.savefig('figures/histograms_CAMS_ATLID_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located.jpg')
...
ax2.legend(frameon=False,fontsize=15)
ax3.legend(frameon=False,fontsize=15)
fig.savefig('figures/histograms_CAMS_ATLID_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located_with_modes.jpg')
