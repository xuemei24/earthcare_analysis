...
day_or_night = 'day'
print('Month=',month)
df = pd.read_csv(file_dir+month+'_2025/'+"2025_"+month+"_cams_atlid_co-located_"+day_or_night+"_aod_snr_gr_2.txt", delimiter=",")
dfuncer = xr.open_dataset(file_dir+month+'_2025/'+"2025_"+month+'_atlid_'+day_or_night+'_uncertainty_snr_gr_2.nc')
...
ax1.set_title('ATLID integrated AOD '+day_or_night+' '+fmonth+' 2025',fontsize=15)
...
plt.tight_layout()
fig.savefig('figures/global_'+day_or_night+'_aod_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located_filtered_uncertainty.jpg',bbox_inches='tight')
...
ax1.set_title('Night '+fmonth+' 2025',fontsize=15)
ax1.legend(frameon=False,fontsize=15)
ax2.legend(frameon=False,fontsize=15)
ax3.legend(frameon=False,fontsize=15)
fig.savefig('figures/histograms_CAMS_ATLID_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located_filtered_'+day_or_night+'_uncertainty_with_modes.jpg')
