...
day_or_night = 'day'
print('Month=',month)
dfaod = pd.read_csv(file_dir+month+'_2025/'+"2025_"+month+"_cams_atlid_co-located_"+day_or_night+"_aod_snr_gr_2.txt", delimiter=",")
dfaod_var = pd.read_csv(file_dir+month+'_2025/'+"2025_"+month+"_cams_atlid_co-located_"+day_or_night+"_aod_variance_snr_gr_2.txt", delimiter=",")
...
ds.to_netcdf(cams_dir+'2025_'+month+'_atlid_'+day_or_night+'_uncertainty_snr_gr_2.nc', format="NETCDF4")
...
plt.tight_layout()
fig.savefig('global_'+day_or_night+'_aod_uncertainty_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located.jpg',bbox_inches='tight')
