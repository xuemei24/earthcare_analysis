...
plt.tight_layout()
fig.savefig('figures/global_'+day_or_night+'_aod_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located.jpg',bbox_inches='tight')
...
fig.savefig('figures/histograms_CAMS_ATLID_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_2025_co-located_'+day_or_night+'_with_modes.jpg')
