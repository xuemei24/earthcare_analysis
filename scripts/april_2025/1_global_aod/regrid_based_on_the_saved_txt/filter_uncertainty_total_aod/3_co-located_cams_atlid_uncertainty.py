...
plt.tight_layout()
fig.savefig('figures/global_'+day_or_night+'aod_uncertainty_'+which_aerosol+'_'+str(reso)+'deg_binned_'+mean_or_std+'_'+month+'_'+year+'_co-located.jpg',bbox_inches='tight')
