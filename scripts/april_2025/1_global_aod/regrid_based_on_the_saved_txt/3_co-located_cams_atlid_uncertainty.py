...
fmonth = 'April'
print('Month=',month)
dfaod = pd.read_csv(file_dir+month+'_2025/'+"2025_"+month+"_cams_atlid_co-located_aod.txt", delimiter=",")
dfaod_var = pd.read_csv(file_dir+month+'_2025/'+"2025_"+month+"_cams_atlid_co-located_aod_variance.txt", delimiter=",")
...
ds.to_netcdf(cams_dir+'2025_'+month+'_atlid_uncertainty.nc', format="NETCDF4")
