...
def read_hdf5(file_path):
    ...
    if which_aerosol == 'total':
        ...
        aer_index = np.array([10,11,12,13,14,15,26])
    ...
    dstdir = "/usr/people/wangxu/Desktop/earthcare_scripts/scripts/april_2025/slices_all_orbits/"
...
file_paths = glob.glob('/net/pc190625/nobackup/users/wangxu/earthcare_data/march_2025/EBD/ECA_EXAE_ATL_EBD_2A_20250328*.h5')
file_paths.sort()
