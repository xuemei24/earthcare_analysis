...
for extinction_coe, lat, lon, height in results:
...
output_filename = "/scratch/nld6854/earthcare/earthcare_data/"+month+"_2025/regridded_CAMS_"+which_aerosol+"_extinction_coe_2deg_"+mean_or_std+"_single_alt_"+month+"_2025_snr_gr_2.nc"
