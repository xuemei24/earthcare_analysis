...
print('ATLID median=',np.nanmedian(aod_atlid[mask]))
print('AERONET median=',np.nanmedian(grid_aod_2d[mask]))
print('ATLID-AERONET median=',np.nanmedian(aod_atlid[mask]-grid_aod_2d[mask]))
print('AERONET,ATLID NMB=',statistics.normalized_mean_bias(aod_atlid[mask],grid_aod_2d[mask]))
print('RMSE=',np.sqrt(np.nanmedian((grid_aod_2d[mask]-aod_atlid[mask])**2)))
...
print('West of Africa diffAOD (ATLID-AERONET)=',np.nanmedian(a_atlid-a_aeronet))
print('North of Africa')
mask = (lat>10) & (lat<30) & (lon>-15) & (lon<32)
a_atlid,a_aeronet = np.where(mask,aod_atlid,np.nan),np.where(mask,grid_aod_2d,np.nan)
print('North of Africa diffAOD (ATLID-AERONET)=',np.nanmedian(a_atlid-a_aeronet))
print('East China')
mask = (lat>21) & (lat<38) & (lon>110) & (lon<122)
a_atlid,a_aeronet = np.where(mask,aod_atlid,np.nan),np.where(mask,grid_aod_2d,np.nan)
print('East China diffAOD (ATLID-AERONET)=',np.nanmedian(a_atlid-a_aeronet))
print('Thailand, Cambodia, Laos, Vietnam')
mask = (lat>9) & (lat<21) & (lon>93) & (lon<110)
a_atlid,a_aeronet = np.where(mask,aod_atlid,np.nan),np.where(mask,grid_aod_2d,np.nan)
print('Thailand, Cambodia, Laos, Vietnam diffAOD (ATLID-AERONET)=',np.nanmedian(a_atlid-a_aeronet))



print('*********Differences between AERONET & CAMS*********')
mask = ~np.isnan(grid_aod_2d) & ~np.isnan(aod_cams)
print('ATLID median=',np.nanmedian(aod_cams[mask]))
print('AERONET median=',np.nanmedian(grid_aod_2d[mask]))
print('ATLID-AERONET median=',np.nanmedian(aod_cams[mask]-grid_aod_2d[mask]))
print('AERONET,ATLID NMB=',statistics.normalized_mean_bias(aod_cams[mask],grid_aod_2d[mask]))
print('RMSE=',np.sqrt(np.nanmedian((grid_aod_2d[mask]-aod_cams[mask])**2)))
...
print('West of Africa diffAOD (ATLID-AERONET)=',np.nanmedian(a_cams-a_aeronet))
print('North of Africa')
mask = (lat>10) & (lat<30) & (lon>-15) & (lon<32)
a_cams,a_aeronet = np.where(mask,aod_cams,np.nan),np.where(mask,grid_aod_2d,np.nan)
print('North of Africa diffAOD (ATLID-AERONET)=',np.nanmedian(a_cams-a_aeronet))
print('East China')
mask = (lat>21) & (lat<38) & (lon>110) & (lon<122)
a_cams,a_aeronet = np.where(mask,aod_cams,np.nan),np.where(mask,grid_aod_2d,np.nan)
print('East China diffAOD (ATLID-AERONET)=',np.nanmedian(a_cams-a_aeronet))
print('Thailand, Cambodia, Laos, Vietnam')
mask = (lat>9) & (lat<21) & (lon>93) & (lon<110)
a_cams,a_aeronet = np.where(mask,aod_cams,np.nan),np.where(mask,grid_aod_2d,np.nan)
print('Thailand, Cambodia, Laos, Vietnam diffAOD (ATLID-AERONET)=',np.nanmedian(a_cams-a_aeronet))
