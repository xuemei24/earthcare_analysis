...
file_dir = '/scratch/nld6854/earthcare/modis/Aqua/hdffiles/monthly_aod/'
print('Month=',month3)
...
bar.ax.set_ylabel('MODIS Particle optical depth / -',fontsize=15)
bar.ax.tick_params(labelsize=15)

ax2.set_title('MODIS AOD '+month2,fontsize=15)
...
ax3.set_title('MODIS-AERONET AOD '+month2,fontsize=15)


plt.tight_layout()
fig.savefig('global_AERONET_MODIS_aod_'+month2+'_'+year+'_100km.jpg',bbox_inches='tight')
