...
print('Month=',month3)
df = pd.read_csv(file_dir+"2025_"+month3+"_atlid_aeronet_co-located_100km_1atlid_per_aeronet.csv", delimiter=",")
...
plt.tight_layout()
fig.savefig('global_AERONET_ATLID_aod_'+month2+'_2025_100km_test.jpg',bbox_inches='tight')
